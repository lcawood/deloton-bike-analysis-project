...
def pipeline():
    ...
    while True:
        ...
        if "beginning of a new ride" in log_line:
            ...
            user['max_heart_rate'] = validate_heart_rate.calculate_max_heart_rate(
                user)
            user['min_heart_rate'] = validate_heart_rate.calculate_min_heart_rate(
                user)
            ...
            reading = transform.get_reading_data_from_log_line(
                reading, log_line, ride_info['start_time'])
