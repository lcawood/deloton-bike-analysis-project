...
def test_user_pipeline(mock_min_heart_rate, mock_max_heart_rate, mock_load_user, mock_load_address, mock_transform_address, mock_transform_user):
    """
...
def test_ride_pipeline(mock_load_ride, mock_transform_ride):
    ...
    mock_load_ride.assert_called_once_with({'key': 'value in a dictionary of ride info', 'bike_id': 2})
...
def test_reading_pipeline(mock_load_reading, mock_send_email, mock_transform_reading):
    ...
    assert consecutive_extreme_hrs == []
    assert reading == {'ride_id': ride_id}
...
@patch('load.add_bike')
def test_pipeline(mock_load_bike, mock_transform_bike, mock_reading_pipeline, mock_ride_pipeline, mock_user_pipeline, mock_get_kafka_consumer, mock_get_next_log_line):
    ...
    mock_get_next_log_line.side_effect = [
        ...
        "2022-07-25 16:13:31.709082 mendoza v9: [INFO]: Ride - duration = 454.0; resistance = 60\n",
        "2022-07-25 16:13:32.209086 mendoza v9: [INFO]: Telemetry - hrt = 0; rpm = 30; power = 11.22896664\n",
        "2022-07-25 16:13:32.709090 mendoza v9: [INFO]: Ride - duration = 455.0; resistance = 60\n",
        "2022-07-25 16:13:33.209093 mendoza v9: [INFO]: Telemetry - hrt = 0; rpm = 30; power = 11.22896664\n",
        "2022-07-25 16:13:33.709097 mendoza v9: [INFO]: Ride - duration = 456.0; resistance = 60\n",
        "2022-07-25 16:13:34.209100 mendoza v9: [INFO]: Telemetry - hrt = 0; rpm = 32; power = 12.54785501\n",
        "2022-07-25 16:13:34.709104 mendoza v9: [INFO]: Ride - duration = 457.0; resistance = 60\n",
        "2022-07-25 16:13:35.209108 mendoza v9: [INFO]: Telemetry - hrt = 0; rpm = 29; power = 10.59008846\n",
        "--------- beginning of main\n",
        "--------- beginning of a new ride\n",
        "2022-07-25 16:13:36.709117 mendoza v9: Getting user data from server..\n",
        "2022-07-25 16:13:37.209120 mendoza v9: [SYSTEM] data = {\"user_id\":815,\"name\":\"Wayne Fitzgerald\",\"gender\":\"male\",\"address\":\"Studio 3,William alley,New Bethan,WR4V 7TA\",\"date_of_birth\":-336700800000,\"email_address\":\"wayne_fitzgerald@hotmail.com\",\"height_cm\":187,\"weight_kg\":52,\"account_create_date\":1641254400000,\"bike_serial\":\"SN0000\",\"original_source\":\"offline\"\n",
        "2022-07-25 16:13:37.709125 mendoza v9: [INFO]: Ride - duration = 1.0; resistance = 30\n",
        "2022-07-25 16:13:38.209128 mendoza v9: [INFO]: Telemetry - hrt = 0; rpm = 0; power = 0.0\n",
        "2022-07-25 16:13:38.709132 mendoza v9: [INFO]: Ride - duration = 2.0; resistance = 30\n",
        "2022-07-25 16:13:39.209136 mendoza v9: [INFO]: Telemetry - hrt = 84; rpm = 0; power = 0.0\n",
        "2022-07-25 16:13:39.709139 mendoza v9: [INFO]: Ride - duration = 3.0; resistance = 30\n",
        "2022-07-25 16:13:40.209143 mendoza v9: [INFO]: Telemetry - hrt = 84; rpm = 14; power = 1.648772319\n",
        "2022-07-25 16:13:40.709152 mendoza v9: [INFO]: Ride - duration = 4.0; resistance = 30\n",
        "2022-07-25 16:13:41.209157 mendoza v9: [INFO]: Telemetry - hrt = 84; rpm = 27; power = 5.092422057\n",
        "2022-07-25 16:13:41.709160 mendoza v9: [INFO]: Ride - duration = 5.0; resistance = 30\n",
        "2022-07-25 16:13:42.209164 mendoza v9: [INFO]: Telemetry - hrt = 84; rpm = 34; power = 7.473425372\n",
        "2022-07-25 16:13:42.709168 mendoza v9: [INFO]: Ride - duration = 6.0; resistance = 30\n",
        "2022-07-25 16:13:43.209171 mendoza v9: [INFO]: Telemetry - hrt = 85; rpm = 38; power = 8.962429663\n",
        "--------- beginning of main\n",
        "--------- beginning of a new ride\n",
        "2022-07-25 16:13:36.709117 mendoza v9: Getting user data from server..\n",
        "2022-07-25 16:13:37.209120 mendoza v9: [SYSTEM] data = {\"user_id\":815,\"name\":\"Wayne Fitzgerald\",\"gender\":\"male\",\"address\":\"Studio 3,William alley,New Bethan,WR4V 7TA\",\"date_of_birth\":-336700800000,\"email_address\":\"wayne_fitzgerald@hotmail.com\",\"height_cm\":187,\"weight_kg\":52,\"account_create_date\":1641254400000,\"bike_serial\":\"SN0000\",\"original_source\":\"offline\"\n",
